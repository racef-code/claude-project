...
const TRANSLATIONS = {
    en: {
        ...
        'modal.upload.title':   'Upload Your Photos',
        'modal.upload.subtitle':'Upload 1-5 photos for best results (different angles recommended)',
        'modal.upload.btn':     'Generate Try-On',
        'modal.upload.drop':    'Click to upload or drag and drop',
        'modal.upload.hint':    'JPG, PNG up to 10MB each (max 5 photos)',
    ...
    fr: {
        ...
        'modal.upload.title':   'Téléchargez vos photos',
        'modal.upload.subtitle':'Téléchargez 1 à 5 photos pour de meilleurs résultats (angles différents recommandés)',
        'modal.upload.btn':     'Générer l\'essayage',
        'modal.upload.drop':    'Cliquez pour télécharger ou glissez-déposez',
        'modal.upload.hint':    'JPG, PNG jusqu\'à 10 Mo chacun (max 5 photos)',
